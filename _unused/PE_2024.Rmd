...
# Price **450€ (students and unemployed)/600€ (employed, firms, and organisations)**

---

### [Forbes](https://www.forbes.com/sites/bernardmarr/2024/01/23/12-new-jobs-for-the-generative-ai-era/) recognises twelve (12) new Generative AI professions: AI Prompt Engineer, Generative Design Specialist, AI Input And Output Manager, AI Content Reviewer/Content Auditor, AI Trainer, AI Maintenance Engineer, AI Security Specialist, AI Instructor/AI Literacy Educator, AI Ethicist/AI Ethics Officer, AI Compliance Manager/AI Compliance Officer, AI Personality Designer, Custom AI Solution Developer.  

### **LATEST** This version of the Workshop will be archived in February 2024 and replaced by a more advanced, in-depth AI Training/Prompt Engineering Workshop. The January/February group will be the last to which the Workshop will be offered at EUR 350, the new pricing will be EUR 450 (for students and unemployed) and EUR 600 (for companies and organizations).

### **January 2024 UPDATE ** The Workshop is extended to include examples of [Google Bard](https://bard.google.com/chat) (powered by [Google DeepMind Gemini](https://deepmind.google/technologies/gemini/#introduction)) and [Anthropic Claude v2](https://www.anthropic.com/index/claude-2). We are now working to incorporate Prompt Engineering for visual systems: [Midjourney](https://www.midjourney.com/) and [DALL-E 3](https://openai.com/dall-e-3) are first on our to do list. All principles of Prompt Engineering discussed in the Workshop for LLMs are now concisely presented in one slide deck.

### **December 2023 UPDATE ** Following the [latest updates from OpenAI](https://www.youtube.com/live/U9mJuUkhUzk?si=-NUuQqADc24XVrCa) the Workshop now includes a thorough explanation on how to create your own GPT chatbot or virtual assistant and use it for your purposes.We cover a complete example of a custom GPT creation: [Dehypenizator](https://chat.openai.com/g/g-vR6PJpi3N-dehypenizator).

### **October 2023 UPDATE ** The workshop is now expanded to four (4) sessions of 3 hours each and includes a complete study of the project application or service relying on generative AI - fulfilling the demands of people with a non-tech background who manage teams or work on the product side.
